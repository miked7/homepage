...
const PortfolioWidget = ({ portfolioItem, userProfile }) => {
  ...
  return (
      <div className="portfolio-widget-container">
        ...
        { userProfile.IsEditable ? <img className="delete-icon-portfolio-widget" src={DeleteIcon} onClick={() => { userProfile.removePortfolioItem(portfolioItem.Id); userProfile.save(); } } /> : <p hidden/> }
