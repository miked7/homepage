...
import { DEBUG_USER_NAME, DEBUG_DOMAIN, isDebug } from "../utils/environment"

export const createUserProfile = () =>  {
    if (isDebug()) {
        return new UserProfile(DEBUG_USER_NAME, DEBUG_DOMAIN);
    }
    else {
        ...
        return new UserProfile(getSubdomain(), getDomain());
    }
};